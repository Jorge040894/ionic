...
/*!*****************************************************!*\
  !*** ./node_modules/ng-event-source/eventsource.js ***!
  \*****************************************************/
/*! exports provided: EventSourcePolyfill */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "EventSourcePolyfill", function() { return EventSourcePolyfill; });
/** @license
 * eventsource.js
...
/* harmony import */ var ng_event_source__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ng-event-source */ "./node_modules/ng-event-source/eventsource.js");
...
var NotificationService = /** @class */ (function () {
    ...
    function NotificationService(httpClient) {
        ...
        /* -------------------------------------------------------------------------------------------------------------- */
        this.serviceURL = 'http://192.168.0.13:8585/persona';
    ...
    NotificationService.prototype.getPersonaNotification = function () {
        ...
        return rxjs__WEBPACK_IMPORTED_MODULE_3__["Observable"].create(function (observer) {
            ...
            var eventSource = new ng_event_source__WEBPACK_IMPORTED_MODULE_4__["EventSourcePolyfill"](url, {
...
var Tab2PageModule = /** @class */ (function () {
    ...
    Tab2PageModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_3__["NgModule"])({
            ...
            providers: [_services_api_service__WEBPACK_IMPORTED_MODULE_7__["apiservice"], _services_notification_service__WEBPACK_IMPORTED_MODULE_9__["NotificationService"]]
        })
    ], Tab2PageModule);
...
var Tab2Page = /** @class */ (function () {
    /*lstcampos:any;*/
    function Tab2Page(servicio, notificationService) {
        this.servicio = servicio;
        this.notificationService = notificationService;
    }
    Tab2Page.prototype.ngOnInit = function () {
        var _this = this;
        this.envivo = new rxjs_index__WEBPACK_IMPORTED_MODULE_3__["BehaviorSubject"](null);
        // realizar suscripcion
        this.doNotificationSubscription();
        this.servicio.obtener().subscribe(function (data) {
            _this.lstcampos = data;
            _this.envivo.next(_this.lstcampos);
        });
    };
    Tab2Page.prototype.doNotificationSubscription = function () {
        var _this = this;
        try {
    ...
    Tab2Page.prototype.handleMessageReceived = function (message) {
        console.log(message);
